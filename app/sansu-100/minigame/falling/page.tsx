...
export default function FallingPage(): React.JSX.Element {
  ...
  const handleGameOver = useCallback(
    async (score: number) => {
      ...
      try {
        const res = await sansuApi.awardBadge(currentUser.id, newBadges, score, 'falling');
