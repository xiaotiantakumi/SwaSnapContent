...
export function MobileMenu({
  ...
  return (
    <div className="relative md:hidden">
      ...
      >
        <svg className="size-6 text-gray-600 dark:text-gray-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      {/* メニュー内容 */}
      {isOpen && (
        <div className="absolute right-0 top-12 z-50 w-64 rounded-lg border border-gray-200 bg-white py-2 shadow-xl dark:border-gray-700 dark:bg-gray-800">
          {/* ファイル追加 */}
          <button
            type="button"
            onClick={handleOpenFiles}
            disabled={isLoading}
            className="flex w-full items-center px-4 py-3 text-left transition-colors hover:bg-gray-50 disabled:opacity-50 dark:hover:bg-gray-700"
          >
          ...
          {supportsClipboard && (
            <button
              type="button"
              onClick={handlePaste}
              className="flex w-full items-center px-4 py-3 text-left transition-colors hover:bg-gray-50 dark:hover:bg-gray-700"
            >
          ...
          {files.length > 0 && (
            <>
              ...
              <button
                ...
                className="flex w-full items-center px-4 py-3 text-left transition-colors hover:bg-red-50 dark:hover:bg-red-900/20"
              >
